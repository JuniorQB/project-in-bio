...
export default function Pricing() {
  return (
    <div className="my-[150px] flex flex-col gap-14 items-center">
      <div className="flex flex-col items-center gap-6">
        ...
        <p className="text-content-body text-xl text-center">Junte-se a comunidade de criadores profissionais que já estão elevando sua<br />
          presença online. Teste gratuitamente por <strong className="text-accent-pink">{TRIAL_DAYS} dias</strong>, sem compromisso</p>
      </div>
      <div className="flex items-end gap-9">
        <div className="w-[304px] p-8 flex flex-col gap-7 rounded-2xln border border-[#1e1e1e]">
        ...
        <div className="flex flex-col">
          ...
          <div className="p-[1.6px] bg-[linear-gradient(90deg,#4b2dbb_0%,#b5446b_100%)] rounded-b-2xl">
            <div className="w-full bg-background-secondary p-8 flex flex-col gap-7 rounded-b-2xl">
              <div className="flex flex-col">
                <span className="font-bold text-white text-2xl">Vitalício</span>
